...
Large processed Seurat objects and HUMESS model outputs are not committed to GitHub. Reproducibility materials are available in the [Figshare record](https://doi.org/10.6084/m9.figshare.33001412.v1). Stage the required processed inputs in the following layout:
...
Figshare DOI: [`10.6084/m9.figshare.33001412.v1`](https://doi.org/10.6084/m9.figshare.33001412.v1). The final Nature Communications citation should be added after journal publication.
